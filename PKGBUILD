...
optdepends=(
    'libjpeg6-turbo: improves printing results for color i-SENSYS LBP devices'
...
source=(
    "http://gdlp01.c-wss.com/gds/${_dl}/linux-UFRIILT-drv-v${_pkgver//\./}-uken-18.tar.gz"
    replace_incorrect_int_with_char.patch
)
md5sums=(
    '8bc3a4e3c372bb4d1b9af2cc012c720b'
    '8bc26ff46bf5877b5800b77685d5d917'
)
sha512sums=(
    'e7b964f3d4541e1ec9ba07eac17559233ab2db16d1f025ffd8a46a65297c63205b7a3cdc031d95f04d719e97eaf93fd763bdc6c27f12c5aac346bb4f204d5967'
...
prepare() {
    ...
    pushd "${_driver_dir}"
    for i in "cngplp/files" "cngplp" "cpca" "StatusMonitor"; do
        pushd "$i"
        autoreconf -i
        popd
    done
